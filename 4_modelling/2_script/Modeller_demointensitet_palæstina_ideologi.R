...
M2_liberal_15_intensity <- glm.nb(
  communication_window_7 ~ demonstration_intensity_palestine + demonstration_intensity_total_7_after, 
  data = data_liberal_15
)
...
filtered_results <- model_results %>%
  filter(term == "demonstration_intensity_palestine")
...
# Gemmer figuren
ggsave(
  filename = "/Users/carlgammeltoft/Lokale dokumenter/R_speciale/4_modelling/3_output/plots_demointensitet_ideologi_kategorisk/pro_palestine.pdf",
  plot = final_plot,
  width = 12, height = 6
)
