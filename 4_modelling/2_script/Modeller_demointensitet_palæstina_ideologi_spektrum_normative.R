...
# Gem figuren
ggsave(
  filename = "/Users/carlgammeltoft/Lokale dokumenter/R_speciale/4_modelling/3_output/plots_normative/pro-palæstina.pdf",
  plot = combined_plot,
  width = 12, height = 6
)


# 1) Tabel for normative pro-palæstinensiske demonstrationer blandt konservative
results_kons_normative %>%
  ...
  kable(
    format    = "latex",
    booktabs  = TRUE,
    caption   = "Effekt af pro-palæstinensiske *normative* demonstrationer på kommunikation blandt konservative politikere",
...
# 2) Tabel for normative pro-palæstinensiske demonstrationer blandt liberale
results_lib_normative %>%
  ...
  kable(
    format    = "latex",
    booktabs  = TRUE,
    caption   = "Effekt af pro-palæstinensiske *normative* demonstrationer på kommunikation blandt liberale politikere",
