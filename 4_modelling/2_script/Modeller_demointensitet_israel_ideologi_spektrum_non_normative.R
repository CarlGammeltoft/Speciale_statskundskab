...
# Kør modeller for alle og ikke-normative demonstrationer -------------------------
...
# Gem figuren
ggsave(
  filename = "/Users/carlgammeltoft/Lokale dokumenter/R_speciale/4_modelling/3_output/plots_non_normative/pro-israelske.pdf",
  plot = combined_plot,
  width = 12, height = 6
)
